...
class ofxPiMapper {
	public:
        ...
        void playForSurface(unsigned int i);
        void stopForSurface(unsigned int i);
        void pauseForSurface(unsigned int i);
        void resumeForSurface(unsigned int i);
    
        ofx::piMapper::BaseSurface* getSurfaceAt(int index);
