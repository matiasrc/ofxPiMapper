...
class BaseSurface {
	...
	public:
        ...
        char getAssignedKey(); //AGREGADO MATIAS 07.2024
        void setAssignedKey(char key); //AGREGADO MATIAS 07.2024
        std::string& getOscAddress() ; //AGREGADO MATIAS 07.2024
        void setOscAddress(std::string& address); //AGREGADO MATIAS 07.2024
	...
	protected:
        ...
        //----INICIO AGREGADO MATIAS 07.2024
        std::string oscAddress; // Dirección base OSC
        char assignedKey; //Tecla para controlar la ejecución del contenido
        //----FIN AGREGADO MATIAS 07.2024
};
