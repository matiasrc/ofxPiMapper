...
void QuadSurface::draw(){
    ofEnableAlphaBlending(); //AGREGADO MATIAS 07.2024
...
BaseSurface * QuadSurface::clone(){
    ...
    s->setAssignedKey(getAssignedKey()); //AGREGADO MATIAS 07.2024
    s->setOscAddress(getOscAddress()); //AGREGADO MATIAS 07.2024
