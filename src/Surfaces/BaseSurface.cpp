...
void BaseSurface::setOscAddress(std::string& address) { //AGREGADO MATIAS 07.2024
        oscAddress = address;
    }

std::string& BaseSurface::getOscAddress() { //AGREGADO MATIAS 07.2024
    return oscAddress;
}

void BaseSurface::setAssignedKey(char key) { //AGREGADO MATIAS 07.2024
    assignedKey = key;
}

char BaseSurface::getAssignedKey() { //AGREGADO MATIAS 07.2024
    return assignedKey;
}

//----FIN AGREGADO MATIAS 22.07.2024
